...
describe('Persistent Node Chat Server', function() {
  ...
  it('Should output all messages from the DB', function(done) {
    ...
    var messageText = 'Death is but a door. Time is but a window. I\'ll be back.';
    ...
    var queryString3 = 'INSERT INTO messages (user, body, room) VALUES (?, ?, ?);';
    var queryArgs = [userKey, messageText, roomKey];
    // TODO - The exact query string and query args to use
    // here depend on the schema you design, so I'll leave
    // them up to you. */

    dbConnection.query(queryString1, ['Vigo'], (err) => { throw err; });
    dbConnection.query(queryString2, ['Museum'], (err) => { throw err; });
